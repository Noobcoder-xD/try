...
BOT_TOKEN = getenv("BOT_TOKEN", "6633156944:AAEsd5V0RYKnQ4Z5ZqIJ9sTs7a6typMQB-w")
# Add Owner Username without @ 
OWNER_USERNAME = getenv("OWNER_USERNAME","RowanxD")
# Get Your bot username
BOT_USERNAME = getenv("BOT_USERNAME" , "MusiczXRobot")
# Don't Add style font 
BOT_NAME = getenv("BOT_NAME" , "Beatrix Music")
#get Your Assistant User name
ASSUSERNAME = getenv("ASSUSERNAME" , "BeatrixAssistant")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Noobcoder-xD/try",
)
